 ...
 */
@Slf4j
public class EdgeWeightedDigraphFactory {

  @Getter
  @Setter
  private Splitter splitter = Splitter.on(" ").omitEmptyStrings().trimResults();

  public <T extends EdgeWeightedDigraph> T loadGraph(T impl, String edgesFilePath) {
  ...
  private void addEdges(EdgeWeightedDigraph impl, List<String> lines) {
    for (String line : lines) {
      ...
      impl.addEdge(new DirectedEdgeImpl(weight,p, q));
    }
  }
}
