...
import static algorithms.sedgewick.ch3_search.symboltable.RedBlackNode.BLACK;
import static algorithms.sedgewick.ch3_search.symboltable.RedBlackNode.RED;

/**
 * Created by Chen Li on 2017/7/24.
 */
public class RedBlack24BST<K extends Comparable<K>, V> extends AbstractOrderedST<K, V> {
