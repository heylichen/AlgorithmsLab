package algorithms.ch1fundamentals.cp;

import algorithms.ch1fundamentals.impl.Node;
...
public class JosephusProblem {
    private static class CycleLinkedList<T> {
        ...
        public boolean isLastNode(algorithms.ch1fundamentals.impl.Node<T> node) {
        ...
        public algorithms.ch1fundamentals.impl.Node<T> getHead() {
            return head;
        }
